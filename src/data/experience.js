  export const experience = [
    {
      ...
      responsibilites: [
        "Responded to client request and Product owner to ensure satisfaction and project success",
        "Collaborated effectively with Product Owner, QA and Backend Developers",
        "Diagnose and resolve bugs across multiple environments (DEV, UAT & PROD)",
        "Integrate API's using REST",
        "Manage deployment processes and releases",
      ]
    },
    {
      ...
      responsibilites: [
        ...
        "Collaborated effectively with Product Owners, UI/UX Designers and Testers",
        "Diagnose and resolve bugs across multiple environments (FAT, UAT & PROD)",
        "Manage deployment processes and seal branches pre-release",
      ]
    },
  ]